...
console.log('US:     ', new Intl.NumberFormat('en-US').format(num)); // US:      38,847,423.23
console.log('Germany:     ', new Intl.NumberFormat('de-DE').format(num)); //  Germany:      38.847.423,23
console.log('Syria:     ', new Intl.NumberFormat('ar-SY').format(num)); //  Syria:      ٣٨٬٨٤٧٬٤٢٣٫٢٣
console.log(
  navigator.language,
