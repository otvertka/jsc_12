...
const locale = navigator.language; // считывает язык интерфейса пользователя
console.log(locale);

labelDate.textContent = new Intl.DateTimeFormat(locale, options).format(now); // ПЕреводим в формат страны
